<section class="cms-a11y-ribbon" id="cms-a11y-ribbon" data-a11y-ui data-a11y-ribbon aria-label="{{ $a11y['labels']['panel_title'] }}">
    <div class="cms-a11y-ribbon__bar">
        <div class="cms-a11y-ribbon__meta">
            <span class="cms-a11y-ribbon__eyebrow">A11Y</span>
            <strong class="cms-a11y-ribbon__title">{{ $a11y['labels']['panel_title'] }}</strong>
        </div>
    ...
    <div class="cms-a11y-ribbon__inner">
        <div class="cms-a11y-group cms-a11y-group--compact cms-a11y-group--size">
        ...
        <div class="cms-a11y-group cms-a11y-group--contrast">
        ...
        <div class="cms-a11y-group cms-a11y-group--images">
        ...
        <div class="cms-a11y-group cms-a11y-group--speech">
        ...
        <div class="cms-a11y-group cms-a11y-group--spacing">
        ...
        <div class="cms-a11y-group cms-a11y-group--leading">
        ...
        <div class="cms-a11y-group cms-a11y-group--font">
        ...
        <div class="cms-a11y-group cms-a11y-group--embeds">
